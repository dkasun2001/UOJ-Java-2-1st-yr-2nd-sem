public class TestCircle {
    public static void main(String[] args) {
        ...
        System.out.println(); 
        System.out.println(C1.toString()); // This circle has [ radius = 1.1 Colour = Blue]

        Circle C4 = new Circle(3.98, "Blue");
        System.out.println(C4); // This circle has [ radius = 3.98 Colour = Blue]
    }
}
