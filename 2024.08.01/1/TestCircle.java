public class TestCircle {
    public static void main(String[] args) {
       /*  Circle C1 = new Circle(2.0,"Blue");
        ...
        System.out.println("Radius of C2 is "+ C2.radius); // error: radius has private access in Circle
        System.out.println("Colour of C2 is "+ C2.colour); // error: colour has private access in Circle
